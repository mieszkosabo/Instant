...
requiredStackSizeStmt (SExp e) = requiredStackSize e + 1 -- + 1 to account for pushing print stream

requiredStackSizeForProgram :: [Stmt] -> Int
requiredStackSizeForProgram = foldr (max . requiredStackSizeStmt) 0
